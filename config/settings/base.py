...
DATABASES = {
    "default": env.db(
        "DATABASE_URL",
        default="postgres://cookie:password@127.0.0.1:5432/events",
    ),
}
...
LOCAL_APPS = [
    "events.users",
    "events.customer.apps.CustomerConfig",
...
MIGRATION_MODULES = {"sites": "events.contrib.sites.migrations"}
...
ADMINS = [("""aishu""", "aishu@example.com")]
...
ACCOUNT_FORMS = {"signup": "events.users.forms.UserSignupForm"}
# https://django-allauth.readthedocs.io/en/latest/configuration.html
